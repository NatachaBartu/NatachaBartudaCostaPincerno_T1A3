...
class Program
    ...
    def welcome
        ...
        puts font.write("Get Track on Diet!!!")
    end
    ...
    def calculation
        ...
        print TTY::Box.frame "To lose weight, your daily calories needs are #{calories}!".colorize(:red)
        puts
    end
    ...
    def thanks
        font = TTY::Font.new(:doom)
        puts font.write("Thanks for using the app")
    end
end      
